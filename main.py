...
# Task 11: You're building a simple banking system.
# Given an initial deposit amount, calculate the amount of money in the bank account after 5 years
# if the interest is compounded annually at a rate of 3%.
# Print the result after rounding to 2 decimal places.
